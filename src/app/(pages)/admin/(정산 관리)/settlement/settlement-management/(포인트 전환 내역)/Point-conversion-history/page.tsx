  ...
  <TableBody>
    {items.map((row) => (
      <TableRow key={row.number} className="border-b-1">
        ...
        <TableCell className="truncate">{row.turningPoints}</TableCell>
        <TableCell className="truncate">
          
            {row.naverPoints}
          
        </TableCell>
        <TableCell className="truncate text-[#248DEE]">{row.conversionResults}</TableCell>
        <TableCell className="truncate"> <Link href='' className='underline underline-offset-1' >{row.viewDetails}</Link></TableCell>
