      ...
      <div className="bg-white py-5 px-10 rounded-[20px] mt-9">
        <header className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button className="py-3 px-10 rounded-md bg-mainBlack text-white" onClick={onblockBtn}>
              회원 차단
            </Button>
          </div>
        </header>
          ...
          {(onClose) => (
            <>
              <ModalBody>
                ...
                <h3 className="mt-3 text-mainBlack font-bold text-3xl text-center">회원 삭제</h3>

                <p className="font-normal text-lg text-grayLight">삭제하면 되돌릴 수 없어요</p>
          ...
          {(onClose) => (
            <>
              <ModalBody>
                ...
                <h3 className="mt-3 text-secondaryBlack font-bold text-xl text-center">차단을 해제하시겠습니까?</h3>
          ...
          {(onClose) => (
            <>
              <ModalBody>
                ...
                <h3 className="mt-3 text-secondaryBlack font-bold text-xl text-center">회원 제재</h3>
                <div className="mt-8">
            <div className=" flex items-center justify-center gap-10 ">
              <p className="font-bold text-sm text-secondWhiteGray">제재기간</p>
            ...
            <div className="mt-4 w-full">
              <InputWithLabel label="제재사유" labelStyles="font-bold text-sm text-secondWhiteGray min-w-[88px]"/>
            </div>
          </div>
